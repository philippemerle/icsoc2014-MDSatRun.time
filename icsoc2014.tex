...
%% La  Figure ~\ref{fig:seq2}, montre la suite de l’invocation dans le cas où l’authentification et l'autorisation se d\'eroulent avec succ\`e	s.
%%\begin{figure}[!ht]  
%%\center
%%\includegraphics[height=160pt,width=380pt]{seqGestionEtudiant2.png}
%%\caption{Appel du service «GestionEtudiant» \`a	 la suite du succ\`e	s de l’authentification et de l'autorisation}
%%\label{fig:seq2}
%%\end{figure}
